...
<html lang="en">
  <head>
    ...
    <link href="<?php echo ROOT.'themes'.DS.'simplex'.DS.'css'.DS.'profile.css';?>" rel="stylesheet">
    <link href="<?php echo ROOT.'themes'.DS.'simplex'.DS.'css'.DS.'wall.css';?>" rel="stylesheet">
...
<body>
  ...
  <div class="body">
      <div class="container-main pad-20">
        ...
        <div class="sidebar bcol-30">
            <?php pathang::snippet('notifications'); ?>
            <?php pathang::snippet('followers'); ?><br>
            <?php pathang::snippet('following'); 
  ...
  <div class="footer">
    <div class="container-main footer-inner pad-20"><?php pathang::Snippet('footer'); ?></div>
   </div> 
</body>
</html>